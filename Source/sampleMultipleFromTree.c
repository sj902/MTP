...
//               (((finish1.tv_sec - start1.tv_sec) * 1.0e3) + ((finish1.tv_nsec - start1.tv_nsec) / 1.0e6)));
            i_cost1 += (((finish1.tv_sec - start1.tv_sec) * 1.0e3) + ((finish1.tv_nsec - start1.tv_nsec) / 1.0e6));
        }

        printf("%ld,%f", numSamples, i_cost1 / 100);
...
//            result2 = sampleFromTree(mainFilter, rooted, numSamples);
//
//        clock_gettime(CLOCK_MONOTONIC, &finish);
//
//
//        printf("%ld,%lf \n",numSamples,
//               (((finish.tv_sec - start2.tv_sec) * 1.0e3) + ((finish.tv_nsec - start2.tv_nsec) / 1.0e6)));
